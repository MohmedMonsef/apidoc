define({ "api": [
  ...
  {
    "type": "get",
    "url": "api/albums/listeners-per-day/{album_id}",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl --location --request GET 'http://localhost:3000/api/albums/listeners-per-day/5eb0a499ec0c444e9c489820?day=8&year=2020&month=6' \\",
        "type": "curl"
      }
    ],
    "success": {
  ...
  {
    "type": "get",
    "url": "api/albums/listeners-per-month/{album_id}",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl --location --request GET 'http://localhost:3000/api/albums/listeners-per-month/5eb0a499ec0c444e9c489820?year=2020&month=6' \\",
        "type": "curl"
      }
    ],
    "success": {
  ...
  {
    "type": "get",
    "url": "api/albums/listeners-per-year/{album_id}",
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl --location --request GET 'http://localhost:3000/api/albums/listeners-per-year/5eb0a499ec0c444e9c489820?year=2020' \\",
        "type": "curl"
      }
    ],
    "success": {
        ...
        "Response": [
          {
            ...
            "optional": false,
            "field": "Format",
            "description": "<p>On success, the HTTP status code in the response header is 200 OK and the response body</br> contains a JSON array of numbers of followers for an artist per day/month/year.</br> On error, the header status code is an error code and the response body contains an error object.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "api/Albums/numberOfLikes/id",
    "title": "Get number of likes for an album.",
    "name": "Get_number_of_likes_for_an_album_per_day,_month_and_year",
    "group": "Library",
    "version": "1.1.0",
    "description": "<p style=\"color:red;\">Get number of likes for an album per day, month and year.</p> <h1>Request Parameters</h1></br></br> <h1> Endpoint</h1>",
    "header": {
      "fields": {
        "Header": [
          {
        ...
        "Path Parameters": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Required. the album's Spotify ID to check.</br> For example: id=74ASZWbe4lXaubB36ztrGX A maximum of 1 can be sent in one request.</p>"
          }
        ],
        "Response": [
          {
            ...
            "optional": false,
            "field": "Format",
            "description": "<p>On success, the HTTP status code in the response header is 200 OK and the response body</br> contains a JSON array of numbers of likes for an album per day/month/year.</br> On error, the header status code is an error code and the response body contains an error object.</p>"
          }
        ]
      }
    },
